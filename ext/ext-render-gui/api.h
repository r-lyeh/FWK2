...
void gui_panel_id(int id, vec4 rect, const char *skin) {
    (void)id;
    vec4 scissor={0, 0, app_width(), app_height()};
    ...
    glScissor(scissor.x, app_height()-scissor.w-scissor.y, scissor.z, scissor.w);
...
void skinned_draw_missing_rect(vec4 r) {
    ...
    quad_render(texture_checker(), v42v2(size), 0x800080FF, v42v2(r), true);
}
...
void skinned_draw_sprite(float scale, atlas_t *a, atlas_slice_frame_t *f, vec4 r) {
    ...
    if (!f->has_9slice) {
        quad_render(a->tex, v42v2(f->bounds), 0xFFFFFFFF, v42v2(r), true);
        return;
    }
    ...
    quad_render(a->tex, v42v2(center_slice), 0xFFFFFFFF, v42v2(center), true);
    quad_render(a->tex, v42v2(top_left_slice), 0xFFFFFFFF, v42v2(top_left), true);
    quad_render(a->tex, v42v2(top_right_slice), 0xFFFFFFFF, v42v2(top_right), true);
    quad_render(a->tex, v42v2(bottom_left_slice), 0xFFFFFFFF, v42v2(bottom_left), true);
    quad_render(a->tex, v42v2(bottom_right_slice), 0xFFFFFFFF, v42v2(bottom_right), true);
    quad_render(a->tex, v42v2(top_middle_slice), 0xFFFFFFFF, v42v2(top), true);
    quad_render(a->tex, v42v2(bottom_middle_slice), 0xFFFFFFFF, v42v2(bottom), true);
    quad_render(a->tex, v42v2(middle_left_slice), 0xFFFFFFFF, v42v2(left), true);
    quad_render(a->tex, v42v2(middle_right_slice), 0xFFFFFFFF, v42v2(right), true);
}
