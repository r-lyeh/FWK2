...
#define window_has_maximize app_has_maximize
#define window_handle() app_handle("window")
#define window_scale() 1.f
#define window_fps render_fps
#define window_fps_target fps_get_target
#define window_has_pause app_has_pause

#define was_deprecated(old,new) old##__renamed__##new
