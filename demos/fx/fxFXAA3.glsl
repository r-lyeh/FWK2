...
#define FXAA_QUALITY__PRESET 15 // 15,29,39
...
void main()
{
    vec4 src = texture2D(iChannel0, texcoord.st);
    ...
    vec4 AA = FxaaPixelShader(
        ...
        vec4(0.0), // @deprecate
        vec4(0.0), // @deprecate
        0.7500, // FXAA_QUALITY__SUBPIX: amount of sub-pixel aliasing removal [0..1]
        0.1666, // FXAA_QUALITY__EDGE_THRESHOLD: minimum amount of local contrast required to apply algorithm [0.063..0.333]
#if FXAA_GREEN_AS_LUMA
        0.0000, // FXAA_QUALITY__EDGE_THRESHOLD_MIN: trims the algorithm from processing darks [0.0312,0.0833]
#else
        0.0833, // FXAA_QUALITY__EDGE_THRESHOLD_MIN: trims the algorithm from processing darks [0.0312,0.0833]
#endif
        0.0, // @deprecate
        0.0, // @deprecate
        0.0, // @deprecate
